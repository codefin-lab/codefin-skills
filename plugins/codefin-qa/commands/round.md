...
Run a test round. Read `references/rounds.md` in the `codefin-qa` skill and work to it.
...
To find out what a change actually touches, use the blast-radius procedure in the `codefin-dev`
