...
gates take; this says what sits behind the four commands, per language.
...
| lint and format | whatever is configured - `oxlint` and `oxfmt` in some repositories, ESLint and Prettier in others. Never add a second one. |
