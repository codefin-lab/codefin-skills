...
Most teams already have all three layers somewhere. What they lack is a way for them to connect,
and a guarantee that any of them ran. This file is about the shape; `references/stacks.md`
has the tools per language.

## The same four commands everywhere

Whatever the language, a repository answers to these four:
...
can walk into any repository and know how to run the tests without reading anything first. Inside, each target calls whatever the language actually uses.
