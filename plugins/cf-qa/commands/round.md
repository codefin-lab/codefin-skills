...
Run a test round. Read `references/rounds.md` in the `cf-qa` skill and work to it.
...
To find out what a change actually touches, use the blast-radius procedure in the `cf-dev`
