...
The three test layers, what belongs in each, and how they run as gates are in the `cf-dev`
...
only the reporter's side. What makes an acceptance criterion testable is in the `cf-ba`
