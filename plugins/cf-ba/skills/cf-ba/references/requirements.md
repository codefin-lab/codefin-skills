...
The document's own conventions fix the tables and identifiers. This is about arriving at content
...
**Priority is not yours.** Record what the PO decided (`cf-po`, `references/priority.md`)
...
The boundary is the PO's call (`cf-po`, `references/scope-and-mvp.md`). Writing it down
