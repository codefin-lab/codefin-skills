---
name: codefin-setup
description: "Set a repository up for the Codefin skills: create the furniture it is missing, install the test gate, and record the few things the repository cannot tell you itself. Run once, by hand."
...
Run the seven steps in `codefin-dev`'s `references/detect.md` - instructions for agents, the task
