...
- Plain descriptive sentences mean the repository writes prose. Match the register and length;
  some Codefin repositories write a paragraph, some write six words.
...
If recent commits carry no trailer, this repository does not want one - some Codefin
repositories forbid AI attribution outright. Match the log; never add a trailer the repository
has not been using.
