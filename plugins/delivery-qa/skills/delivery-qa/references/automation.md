...
**This process assumes QA writes the automation.** That makes the suite QA's own product, with the same
...
Which layer a test belongs to, and how the layers run as gates, is in the `delivery-dev` skill
