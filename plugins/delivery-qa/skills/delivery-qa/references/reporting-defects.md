...
`delivery-dev` skill (`references/defects.md`) and the record template is there too - this page
...
- **Confirm a regression test exists.** The `delivery-dev` procedure requires the reproduction to
